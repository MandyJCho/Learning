...
SWIFT_CLASS("_TtC5Voice11AppDelegate")
...
SWIFT_CLASS("_TtC5Voice20DetailViewController")
@interface DetailViewController : UIViewController
@property (nonatomic, strong) WKWebView * _Null_unspecified webView;
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Null_unspecified detailItem;
- (void)loadView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC5Voice20MasterViewController")
...
@interface NSNumber (SWIFT_EXTENSION(Voice))
