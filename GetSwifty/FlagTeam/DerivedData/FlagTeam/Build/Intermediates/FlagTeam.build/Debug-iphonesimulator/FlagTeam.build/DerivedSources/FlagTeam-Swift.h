...
SWIFT_CLASS("_TtC8FlagTeam11AppDelegate")
...
SWIFT_CLASS("_TtC8FlagTeam14ViewController")
...
- (void)askQuestion:(UIAlertAction * _Null_unspecified)sender;
- (IBAction)flagTapped:(UIButton * _Nonnull)sender;
